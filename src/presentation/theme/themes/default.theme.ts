...
export const defaultTheme = {
  ...
  colors: {
    ...
    surfaceHover: rawColors.neutral.surfaceHover,
    textPrimary: rawColors.neutral.textPrimary,
    textSecondary: rawColors.neutral.textSecondary,
    textTertiary: rawColors.neutral.textTertiary,
    border: rawColors.neutral.border,
    borderStrong: rawColors.neutral.borderStrong,
    ...
    error: rawColors.feedback.danger,
